...
def sleep_edf_clinical_education(args: argparse.Namespace) -> int:
    ...
    print(f"wrote {outputs.report_md}")
    print("wrote reports\\sleep_edf\\clinical_learning_plan.md")
    return 0
...
def mit_bih_psg_respiratory_pilot(args: argparse.Namespace) -> int:
    ...
    print(f"wrote {outputs.dataset_readiness_csv}")
    ...
    print(f"wrote {outputs.report_md}")
    print(f"wrote {outputs.dataset_decision_md}")
    return 0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    validate_parser.add_argument("--manifest", default="data/manifests/fantasia.csv")
    validate_parser.set_defaults(func=validate_data)

    inventory_parser = subparsers.add_parser("inventory-fantasia")
    inventory_parser.add_argument("--config", default="configs/hrv/core.yaml")
    ...
    benchmark_parser.add_argument("--config", default="configs/hrv/core.yaml")
    ...
    rr_artifacts_parser.add_argument("--config", default="configs/hrv/core.yaml")
    ...
    frequency_parser.add_argument("--config", default="configs/hrv/core.yaml")
    ...
    report_parser.add_argument("--config", default="configs/hrv/core.yaml")
    ...
    release_parser.add_argument("--config", default="configs/hrv/core.yaml")
    ...
    sleep_edf_parser.add_argument("--config", default="configs/sleep_edf/default.yaml")
    sleep_edf_parser.set_defaults(func=sleep_edf_preflight)

    sleep_edf_download_parser = subparsers.add_parser("download-sleep-edf")
    sleep_edf_download_parser.add_argument("--config", default="configs/sleep_edf/default.yaml")
    ...
    sleep_edf_validate_parser.add_argument("--config", default="configs/sleep_edf/default.yaml")
    ...
    sleep_edf_benchmark_parser.add_argument("--config", default="configs/sleep_edf/default.yaml")
    ...
    yasa_profile_parser.add_argument("--config", default="configs/sleep_edf/default.yaml")
    ...
    clinical_parser.add_argument("--config", default="configs/sleep_edf/default.yaml")
    ...
    mit_download_parser.add_argument("--config", default="configs/mit_bih_psg/default.yaml")
    ...
    mit_validate_parser.add_argument("--config", default="configs/mit_bih_psg/default.yaml")
    ...
    mit_pilot_parser.add_argument("--config", default="configs/mit_bih_psg/default.yaml")
    ...
    run_parser.add_argument("--config", default="configs/hrv/core.yaml")
