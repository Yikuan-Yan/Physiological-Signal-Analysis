    ...
    out.write_text(
        "\n".join(
            [
                ...
                "13. Next: manually reconcile simple annotation-token burden against source AHI and clinical scoring rules.",
                "14. Next: formalize oxygen desaturation scoring and decide whether to add a richer PSG dataset.",
                "",
                ...
                "",
                "MIT-BIH PSG is now integrated for respiratory-event and SO2 oxygenation learning across all 18 records. Use `reports/respiratory_dataset_candidates.md` to drive source AHI alignment, formal desaturation scoring, and the richer-PSG dataset decision.",
                "",
            ]
        ),
        encoding="utf-8",
