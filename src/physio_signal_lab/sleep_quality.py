    ...
    out.write_text(
        "\n".join(
            [
                ...
                "7. Done: write pilot, five-record, eight-record, and eleven-record educational reports that map data patterns to next clinical questions and missing data.",
                ...
                "12. Next: manually reconcile simple annotation-token burden against source AHI and clinical scoring rules.",
                "",
                ...
                "",
                "MIT-BIH PSG is now integrated for respiratory-event and SO2 oxygenation learning. Use `reports/respiratory_dataset_candidates.md` to decide whether manual scoring reconciliation is enough or whether a richer PSG dataset is needed.",
                "",
            ]
        ),
        encoding="utf-8",
