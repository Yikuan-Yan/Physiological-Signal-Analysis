...
- Records: SC4001, SC4011, SC4021, SC4031, SC4041, SC4051, SC4061, SC4071, SC4081, SC4091, SC4101.
- Epoch size: 30 s.
...
- Hypnogram timeline: `figures/sleep_edf/eleven_record_hypnogram_timeline.png`
- Sleep architecture: `figures/sleep_edf/eleven_record_sleep_architecture.png`
