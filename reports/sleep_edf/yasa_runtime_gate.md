...
Passed for the two-record pilot and the five-record expansion on Python 3.12.13 with YASA 0.7.0, MNE 1.12.1, and scikit-learn 1.9.0.
...
Five-record YASA metrics:

| records | accuracy | balanced accuracy | macro-F1 | Cohen's kappa |
| --- | --- | --- | --- | --- |
| SC4001-SC4041 | 0.793 | 0.711 | 0.631 | 0.628 |
