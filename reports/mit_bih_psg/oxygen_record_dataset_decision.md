...
- Records analyzed: 5.
- Source alignment statuses: needs_manual_review=4, roughly_aligned=1
- Source alignment priorities: manual_review_high=4, manual_review_medium=1
- Oxygen review statuses: artifact_review_recommended=3, oxygen_review_ready=2
- Clinical-style example tiers: manual_source_alignment_needed=4, respiratory_annotation_learning_ready=1

## What The Current Data Can Teach

- Respiratory event burden from sleep/apnea annotations, especially records with roughly aligned source AHI: slp61.
...
- High/medium-priority source-AHI review is still needed for: slp59, slp60, slp61, slp66, slp67x.
