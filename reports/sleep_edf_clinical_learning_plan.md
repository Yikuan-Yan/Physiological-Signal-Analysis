...
7. Done: write pilot, five-record, and eight-record educational reports that map data patterns to next clinical questions and missing data.
...
10. Next: add SO2-channel records so oxygen desaturation burden can be learned from real data.
...
MIT-BIH PSG is now integrated for the first respiratory-event phase. Use `reports/respiratory_dataset_candidates.md` to extend toward SO2-channel records and oxygen desaturation burden.
